...
> on AWS — built as a BSc Cybersecurity & Web Development dissertation.
...
- ⚠️ CSP contains `unsafe-inline` / `unsafe-eval` — flagged for future fix
- ⚠️ Session expiry not auto-enforced — manual sign-out available
